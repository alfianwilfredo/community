            ...
            <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12">
                <div class="mt-12 flex flex-col items-center">
                    ...
                    <div class="w-full flex-1 mt-8">
                        ...
                        <form action="{{ route('register') }}" method="POST" class="mx-auto max-w-xs">
                            @csrf
                            <input class="w-full px-8 py-4 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white" placeholder="Email" name="email" />
                            @error('email')
